...
// Modificar los SVG personalizados para que sean responsive
const XIcon = () => (
  <svg
...
// Modificar el SVG de TikTok para que sea responsive
const TikTokIcon = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const SocialBar = () => {
  return (
    // Cambiar el tamaño de los contenedores de iconos
    <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-40 hidden md:block bg-white p-2 rounded-full shadow-xl">
      <div className="flex flex-col space-y-3">
        {/* Reducir el tamaño de cada botón social */}
        <a
          href="https://www.facebook.com/profile.php?id=100011499285580&ref=ig_profile_ac"
          className="w-10 h-10 md:w-8 md:h-8 lg:w-10 lg:h-10 rounded-full bg-[#1877F2] hover:bg-[#145DBF] flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
          aria-label="Facebook"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Facebook className="h-5 w-5 md:h-4 md:w-4 lg:h-5 lg:w-5" />
        </a>
        ...
        <a
          ...
          className="w-10 h-10 md:w-8 md:h-8 lg:w-10 lg:h-10 rounded-full bg-[#E4405F] hover:bg-[#C13548] flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
          aria-label="Instagram"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Instagram className="h-5 w-5 md:h-4 md:w-4 lg:h-5 lg:w-5" />
        </a>
